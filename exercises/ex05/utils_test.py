...
def test_only_evens_empty_list() -> None:
    """This function tests the only_evens function with an empty list."""
    # one edge case test
    given_list: list[int] = []
    assert only_evens(given_list) == []

def test_only_evens_with_mixed_list() -> None:
    """This function tests the only_evens function with a mixed list."""
    # one use case test
    given_list: list[int] = [1, 4, 5, 6, 8, 9]
    assert only_evens(given_list) == [4, 6, 8]

def test_only_evens_with_odd_list() -> None:
    """This function tests the only_evens function with an odd list."""
    # one use case test
    given_list: list[int] = [3, 5, 7, 11, 15]
    assert only_evens(given_list) == []

def test_concat_empty_lists() -> None:
    """This function tests the concat function with an empty list."""
    # one edge case test
    first_list: list[int] = []
...
def test_concat_full_lists() -> None:
    """This function tests the concat function with a full list."""
    # one use case test
...
def test_concat_full_list_and_empty_list() -> None:
    """This function tests the concat function with a full list and an empty list."""
    # one use case test
    first_list: list[int] = [2, 3, 6]
    second_list: list[int] = []
...
def test_sub_empty_list() -> None:
    """This function tests the sub function with an empty list."""
    # one edge case test
    assert sub([], 0, 0) == []
    assert sub([], -1, 1) == []
    assert sub([], 0, 1) == []
...
def test_sub_valid_list() -> None:
    """This function tests the sub function with a valid input list."""
    # one use case test
...
def test_sub_invalid_start_idx() -> None:
    """This function tests the sub function with an invalid start_idx."""
    # one use case test
    int_list: list[int] = []
    start_idx: int = 4
    end_idx: int = 6
